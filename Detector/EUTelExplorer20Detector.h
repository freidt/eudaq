...
#ifndef EUTELEXPLORER20DETECTOR_H
#define EUTELEXPLORER20DETECTOR_H
...
namespace eutelescope {
  ...
  class EUTelExplorer20Detector : public EUTelPixelDetector {

  public:
    //! Default constructor
    EUTelExplorer20Detector() ;

    //! Default destructor
    virtual ~EUTelExplorer20Detector() {;}
