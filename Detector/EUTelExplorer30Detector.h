...
#ifndef EUTELEXPLORER30DETECTOR_H
#define EUTELEXPLORER30DETECTOR_H
...
namespace eutelescope {
   ...
   *  @version $Id: EUTelExplorer30Detector.h 2285 2013-01-18 13:46:44Z hperrey $
   */

  class EUTelExplorer30Detector : public EUTelPixelDetector {

  public:
    //! Default constructor
    EUTelExplorer30Detector() ;

    //! Default destructor
    virtual ~EUTelExplorer30Detector() {;}
